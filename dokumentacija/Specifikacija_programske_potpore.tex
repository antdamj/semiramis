			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Klikom na odgovarajući gumb ima opciju promijeniti datum preuzimanja vozila (ako vozilo već nije preuzeto) i datum vraćanja vozila.
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Klikom na odgovarajući gumb korisnik obriše rezervaciju
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Prikaz karte bit će dostupan na naslovnoj stranici aplikacije i prilikom odabira mjesta preuzimanja te povrata vozila
