	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\textbf{\textit{Dio 1. revizije}}\\
					...
					\noindent \underbar{\textbf{UC5 - Pregled prijašnjih rezervacija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - Rezervacija vozila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 8 - Promjena rezervacije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 9 - Otkazivanje rezervacije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 10 - Recenziranje usluge}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 11 - Prikaz karte s navedenim poslovnicama}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 12 - Dodavanje vozila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 12 - Uklanjanje vozila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 14 - Uređivanje podataka o vozilu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC15 - Prikaz profitabilnosti i prijašnjih narudžbi}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC16 - Prikaz slobodnih vozila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 - Prikaz aktivnih rezervacija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 18 - Zatvaranje rezervacije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Promjena razine korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 22 - Dodavanje poslovnice}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 23 - Uklanjanje poslovnice}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC 24 - Uređivanje poslovnice}}
					\begin{packed_item}
