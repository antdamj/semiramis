\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Sekvencijski dijagrami}
				...
				vraćanja vozila. Pri slanju zahtjeva provjerava mu se točnost
				unesenih podataka te ako je sve u redu prosljeđuje se upit bazi
				podataka.Baza podataka šalje popis automobila sa njihovim
				...
				prikazuju dostupni automobili uz nadoknadu za narudžbu van
				osnovnih uvjeta(početno je 0 kn). Ako ne postoju automobili sa
