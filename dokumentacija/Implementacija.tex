\chapter{Implementacija i korisničko sučelje}
		...
		\section{Ispitivanje programskog rješenja}
			...
			\begin{figure}[hp]
                    \centering
                    \includegraphics[width=15cm, height=10cm]{slike/logintests.png}
                    \caption{Rezultati testova}
                    \label{fig:useCase-2}
                \end{figure}
			\eject
			...
			\begin{figure}[hp]
                    \centering
                    \includegraphics[width=15cm, height=10cm]{slike/searchtests.png}
                    \caption{Rezultati testova}
                    \label{fig:useCase-2}
                \end{figure}
			\eject
			...
			\begin{figure}[hp]
                    \centering
                    \includegraphics[width=15cm, height=5cm]{slike/passwordbad.png}
